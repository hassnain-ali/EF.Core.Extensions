...
public static class QueryableExtensions
{
    ...
    public static IQueryable<T> WhereIf<T>(this IQueryable<T> source, bool condition, Func<T, int, bool> expression)
        => condition ? source.Where(expression) : source;

    public static IQueryable<T> WhereIf<T>(this IQueryable<T> source, Func<bool> condition, Func<T, bool> expression)
        => condition() ? source.Where(expression) : source;

    public static IQueryable<T> WhereIf<T>(this IQueryable<T> source, Func<bool> condition, Func<T, int, bool> expression)
        => condition() ? source.Where(expression) : source;

    public static IQueryable<T> WhereIf<T>(this IQueryable<T> source, Expression<Func<bool>> condition, Func<T, bool> expression)
        => condition.Compile()() ? source.Where(expression) : source;

    public static IQueryable<T> WhereIf<T>(this IQueryable<T> source, Expression<Func<bool>> condition, Func<T, int, bool> expression)
        => condition.Compile()() ? source.Where(expression) : source;
